...
function GoogleLogin() {
  ...
  return (
    <div
      onClick={handleClick}
      className="border-white1 flex cursor-pointer items-center rounded-xl md:rounded-lg border px-8 py-2.5"
    >
      <img src={GoogleImg} alt="google" className="w-3.5 h-3.5 md:w-6 md:h-6" />
