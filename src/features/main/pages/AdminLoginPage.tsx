  ...
  return (
    <div className="bg-admin-background flex w-full flex-col text-white">
      <div className="mx-auto mt-30 flex min-h-dvh w-full max-w-360 flex-col items-center gap-6">
        ...
        <div className="bg-admin-box flex h-44.75 w-full md:max-w-130.25 max-w-87.5 flex-col items-center justify-center gap-3 md:gap-5 rounded-[10px] border border-none">
          <GoogleLogin />
          <Link
