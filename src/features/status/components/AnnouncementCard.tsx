...
const ANNOUNCEMENT_CARD_CLASS: Record<CardVariant, string> = {
  web: "flex h-41.25 w-94.5 flex-col rounded-2xl bg-admin-box px-7 py-6 shadow-xl",
  mobile:
    "flex h-37.75 w-87.5 items-center justify-center rounded-2xl bg-admin-box shadow-xl",
};
