...
const DROPDOWN_TRIGGER_CLASS: Record<DropdownSize, string> = {
  web: "cursor-pointer flex h-9.25 w-26.75 items-center justify-between rounded-xl bg-admin-box px-3 text-sm font-normal text-admin-white",
  mobile:
    "cursor-pointer flex h-9 w-22.75 items-center justify-between rounded-xl bg-admin-box px-3 text-[13px] font-normal text-admin-white",
};
